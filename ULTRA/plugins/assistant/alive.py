...
async def awake(event):
  ...
  BUTTON = [[Button.url("Mᴀsᴛᴇʀ", f"https://t.me/{bot.me.username}"), Button.url(f"{BOT} Rᴇᴘᴏ", "https://t.me/TheHacker90")]]
...
# inline by LEGENDX22 and PROBOY22 🔥
  PROBOYX +=[[Button.url("Sᴜᴘᴘᴏʀᴛ Group", "https://t.me/kannada_HD_FilmsRequest"), Button.url("My Creator", "https://t.me/TheHacker90")]]
...
async def repo(event):
  await xbot.send_message(event.chat, "**I Cannot Give Repo 🤣🤣** \n\nFᴏʀ Aɴʏ Hᴇʟᴘ :- @TheHacker90", buttons=[[Button.url("⚜️ My Master ⚜️", "https://t.me/TheHacker90"), Button.url("Group", "https://dashboard.heroku.com/new?button-url=https://t.me/kannada_HD_FilmsRequest")]])
